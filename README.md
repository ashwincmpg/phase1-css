...
1. Use the Georgian College server link to view the live website.
2. To view the project locally, download the files from GitHub and open "index.html" in a web browser.
